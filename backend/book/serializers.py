...
from .models import Book, Category, CartItem, Order, OrderItem, Bookmark

User = get_user_model()  # ← only one User import, correct way
...
class BookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Book
        fields = ['id', 'title', 'author', 'price', 'stock', 'image', 'description', 'category', 'category_name', 'is_most_read', 'is_new_release', 'read_count', 'created_at', 'published', 'publisher', 'language', 'pages', 'isbn']
...
class BookmarkSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Bookmark
        fields = ['id', 'book', 'book_title', 'book_author', 'book_price', 'book_image', 'book_category', 'created_at']
